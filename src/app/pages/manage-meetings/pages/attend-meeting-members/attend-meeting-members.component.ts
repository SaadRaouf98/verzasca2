...
import { CloseMeetingCommand, MeetingDetails } from '@core/models/meeting.model';
...
@Component({
  selector: 'app-attend-meeting-members',
  templateUrl: './attend-meeting-members.component.html',
  styleUrls: ['./attend-meeting-members.component.scss'],
})
export class AttendMeetingMembersComponent implements OnInit {
  elementId: string = '';
  ...
  onCloseMeeting(): void {
    ...
    const dataToSend: CloseMeetingCommand = {
    ...
    this.manageMeetingsService.meetingsService.closeMeeting(dataToSend).subscribe({
      next: (res) => {
        this.disableSubmitBtn = true;
        this.toastr.success(
