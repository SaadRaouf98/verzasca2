...
@Component({
  selector: 'app-related-containers-scrollable-table',
  templateUrl: './related-containers-scrollable-table.component.html',
  styleUrls: ['./related-containers-scrollable-table.component.scss'],
  animations: [
...
export class RelatedContainersScrollableTableComponent implements OnInit, OnChanges {
