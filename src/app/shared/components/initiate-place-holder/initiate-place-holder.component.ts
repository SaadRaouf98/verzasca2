...
@Component({
  selector: 'app-initiate-place-holder',
  templateUrl: './initiate-place-holder.component.html',
  styleUrls: ['./initiate-place-holder.component.scss'],
})
export class InitiatePlaceHolderComponent {
  ...
  @Input('user') user!: { id: string; name: string };
  ...
  onDeleteBox(): void {
    this.manageSharedService.deleteInitiatePlaceHolder();
  }
}
