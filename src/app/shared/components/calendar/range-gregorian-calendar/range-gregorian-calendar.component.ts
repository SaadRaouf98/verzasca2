...
@Component({
  selector: 'app-range-gregorian-calendar',
  standalone: true,
  imports: [NgbDatepickerModule, FormsModule, MatDatepickerModule],
  templateUrl: './range-gregorian-calendar.component.html',
  styleUrls: ['./range-gregorian-calendar.component.scss'],
})
export class RangeGregorianCalendarComponent implements OnChanges {
